...
class VboBookingHistory
{
	...
	{
		if (VBOPlatformDetection::isJoomla() && VikBooking::isSite()) {
			/**
			 * @joomlaonly  make sure to load the back-end language definitions and any override
			 */
			$lang = JFactory::getLanguage();
			$lang->load('com_vikbooking', JPATH_SITE, $lang->getTag(), true);
			$lang->load('joomla', JPATH_SITE, $lang->getTag(), true);
		}
